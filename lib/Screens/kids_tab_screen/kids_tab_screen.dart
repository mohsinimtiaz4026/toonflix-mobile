...
class KidsTabScreen extends StatefulWidget {
  const KidsTabScreen({Key? key}) : super(key: key);

  @override
  State<KidsTabScreen> createState() => _KidsTabScreenState();
}

class _KidsTabScreenState extends State<KidsTabScreen> {
  int activeIndex = 0;
