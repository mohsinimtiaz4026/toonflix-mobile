...
class CartoonTabScreen extends StatefulWidget {
  const CartoonTabScreen({Key? key}) : super(key: key);

  @override
  State<CartoonTabScreen> createState() => _CartoonTabScreenState();
}

class _CartoonTabScreenState extends State<CartoonTabScreen> {
  int activeIndex = 0;
